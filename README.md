...
3. Сбалансированность скобок означает, что каждый открывающий символ имеет соответствующий ему закрывающий, 
4. и пары скобок правильно вложены друг в друга.
